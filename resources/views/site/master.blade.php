...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('siteasset/apple-touch-icon.png') }}">
                    ...
                    <div class="shp__cart__wrap">
                        ...
                        <div class="shp__single__product">
                            <div class="shp__pro__thumb">
                                <a href="#">
                                    <img src="{{ $cart->product->image}}" alt="product images">
                                </a>
                            </div>
                            <div class="shp__pro__details">
                                <h2><a href="product-details.html">{{ $cart->product->name }}</a></h2>
                                <span class="quantity">QTY: {{ $cart->product->qty }}</span>
                                <span class="shp__price">${{ $cart->product->price }}</span>
                            </div>
