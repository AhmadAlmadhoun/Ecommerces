                    ...
                    <div class="col-md-8 col-lg-8">
                        <div class="ckeckout-left-sidebar">
                            ...
                            <div class="checkout-form">
                                <h2 style="margin-bottom: 40px" class="section-title-3">Billing details</h2>
                                <script src="https://eu-test.oppwa.com/v1/paymentWidgets.js?checkoutId={{ $checkoutId }}"></script>

                                <form action="{{ route('checkout_thanks') }}" class="paymentWidgets" data-brands="VISA MASTER AMEX"></form>
