                            ...
                            <div class="table-content table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                        <tr>
                                            <td class="product-thumbnail"><a href="{{ route('site.product-details', $cart->product_id) }}"><img src="{{ $cart->product->image }}" alt="product img" /></a></td>
                                            <td class="product-name"><a href="{{ route('site.product-details', $cart->product_id) }}">{{ $cart->product->name }}</a></td>
